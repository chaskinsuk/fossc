...
?>
     ...
     <div class="site-header <?php echo $inner_cls; ?>">  
       <div class="container">    
          <div class="logo">
				<?php yogaclub_lite_the_custom_logo(); ?>
          ...
          <div class="toggle">
                 <a class="toggleMenu" href="#"><?php esc_html_e('Menu','yogaclub-lite'); ?></a>
               </div><!-- toggle --> 
                    ...
                    <div class="page-wrapper">                        
                        ...
                        <?php if( get_theme_mod('services-pagebox'.$n,false)) { ?>          
                            <?php $queryvar = new WP_Query('page_id='.absint(get_theme_mod('services-pagebox'.$n,true)) ); ?>				
                                    ...
                                    <div id="boxbgcolor<?php echo $n; ?>" class="fourclmbox <?php if($n % 4 == 3) { echo "last_column"; } ?>">                                    
                                     ...
                                     <a href="<?php the_permalink(); ?>"><img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/dots-readmore.png" /></a>
                                     </div>                                   
                                    </div>
                                    <?php endwhile;
                                   		 wp_reset_postdata(); ?>                                    
                                    ...
                                    <?php while( $queryvar->have_posts() ) : $queryvar->the_post(); ?>                                     
                                     ...
                                     <div class="welcome-content">
                                       ...
                                       <a class="learnmore" href="<?php the_permalink(); ?>">                                      
                                         <?php esc_html_e('Read More','yogaclub-lite'); ?>
                                      </a>                                                                     
                                    </div>                                      
                                    <?php endwhile;
                                   		 wp_reset_postdata(); ?>                                    
