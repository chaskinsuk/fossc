/*-----------------------------------------------------------------------------------*/
/* Advance Fitness Gym Responsive WordPress Theme */
/*-----------------------------------------------------------------------------------*/
...
Advance Fitness Gym WordPress Theme is derived from Twenty Sixteen WordPress Theme, Copyright 2014-2015 WordPress.org
...
5 - Images used from pixabay.
	...
	Slider image, copyright sifusergej
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/trx-kettlebell-fitness-crossfit-3293471/
	
	About image, copyright sifusergej
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/kettlebell-fitness-crossfit-fit-3293473/
...
======================
Step 1. Go to customizer >> Theme Settings >> Social Icon Links >> here you can add your social links.
...
Step 2. Go to customizer >> Theme Settings >> Services Section >> here you can select the post.

For Welcome
===================
Step 1. Add new post, add title and content then publish it.
Step 2. Go to customizer >> Theme Settings >> Welcome Section >> here you can select the post which you have add welcome section.
...
Advance Fitness Gym Free version
==========================================================
Advance Fitness Gym Free version is compatible with GPL licensed.
